    ...
    <main class="main">
      <div class="content">
        <div class="left-side">
          ...
          <br />
          <a
            class="my-3  bg-red-500 p-4 text-white rounded-2xl"
            routerLink="/example"
            >Go Iframe Test Component</a
          >
          <br />
          <br />
          <button
            type="button"
            class="cursor-pointer p-4 rounded-2xl mt-3 bg-blue-600 text-white"
            (click)="triggerAction()"
          >
            Aksiyon Gönder
          </button>
        ...
        <div class="right-side">
          <div class="iframe-container">
            <iframe
              #iframeElement
              src="https://zippy-profiterole-e399cd.netlify.app/"
              width="100%"
              height="100%"
              title="içerik iframe"
              frameBorder="0"
